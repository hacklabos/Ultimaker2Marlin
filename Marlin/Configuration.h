...
#define HEATER_0_MAXTEMP 300    // 275 C limit in Ultimaker 2 since the PTFE coupler degrades rapidly at higher temperatures.
...
#define MAX_HEATING_CHECK_MILLIS (50 * 1000)
